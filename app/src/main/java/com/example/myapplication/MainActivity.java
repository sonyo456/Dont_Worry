...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView login_id= (TextView) header.findViewById(R.id.login_id);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {//네비게이션 설정
    ...
    @Override
    public boolean onOptionsItemSelected(MenuItem item) {//네비게이션 동작
    ...
    final LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if (location!=null) {
                ...
                System.out.println(acttypeStr);
                String markerTitle = getCurrentAddress(currentPosition);
                String markerSnippet = "행동유형:" + "WALKING";
    ...
    public String getCurrentAddress(LatLng latlng) {
        ...
        if (addresses == null || addresses.size() == 0) {
            ...
            Log.v("알림","주소" + address.getAddressLine(0));
    ...
    public void setCurrentLocation(Location location, String markerTitle, String markerSnippet) {
        ...
        mMap.addMarker(markerOptions).showInfoWindow();//마커 말풍선 계속 뜨케 하기
